...
namespace App.Infra.Data.Db.SqlServer.Ef.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cards",
                columns: new[] { "Id", "Balance", "CVV2", "CardNumber", "HolderName", "IsActive", "Password", "UserId", "WrongPasswordTries" },
                values: new object[,]
                {
                    { 1, 500f, "123", "6219861922113740", "blue", true, "1234", 1, 0 },
                    { 2, 100f, "123", "6219861922113741", "red", true, "1234", 2, 0 }
                });
